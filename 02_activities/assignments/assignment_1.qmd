...
```         
The AIC is 11000 for the recessive model and 10988 for the additive model. This shows that while, the AICs are similar the additive model has a slightly better overall fit.
```
