...
```         
The AIC is 11292 for the recessive model and 11277 for the additive model. This shows that while, the AICs are similar the additive model has a slightly better overall fit as the AIC is slightly lower.
```
